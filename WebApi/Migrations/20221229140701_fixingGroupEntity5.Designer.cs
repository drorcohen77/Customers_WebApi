...
namespace WebApi.Migrations
{
    ...
    [Migration("20221229140701_fixingGroupEntity5")]
    partial class fixingGroupEntity5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApi.Models.FactoriesToCustomer", b =>
                {
                    ...
                    b.Property<int?>("factoriesfactoryCode")
                        .HasColumnType("int");

                    b.Property<int>("factoryCode")
                        .HasColumnType("int");

                    b.Property<int?>("groupsgroupCode")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("factoriesfactoryCode");

                    b.HasIndex("groupsgroupCode");
            ...
            modelBuilder.Entity("WebApi.Models.FactoriesToCustomer", b =>
                {
                    ...
                    b.HasOne("WebApi.Models.Factory", "factories")
                        .WithMany()
                        .HasForeignKey("factoriesfactoryCode");
